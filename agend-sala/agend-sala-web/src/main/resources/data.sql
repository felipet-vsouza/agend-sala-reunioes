...
values(SEQ_AGENDAMENTO.nextval, TO_DATE('2016/12/15 09:00', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 12:00', 'yyyy/mm/dd hh24:mi'), 1, 'Reunião com cliente', 1);

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO, ID_USUARIO, DS_AGENDAMENTO, ID_SALA) 
values(SEQ_AGENDAMENTO.nextval, TO_DATE('2016/12/15 12:10', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 14:00', 'yyyy/mm/dd hh24:mi'), 1, 'Definição de logo', 2);

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO, ID_USUARIO, DS_AGENDAMENTO, ID_SALA) 
values(SEQ_AGENDAMENTO.nextval, TO_DATE('2016/12/15 15:00', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 16:00', 'yyyy/mm/dd hh24:mi'), 1, 'Conversão de dados', 3);
...
INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO, ID_USUARIO, DS_AGENDAMENTO, ID_SALA) 
values(SEQ_AGENDAMENTO.nextval, TO_DATE('2016/12/16 17:30', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/16 19:00', 'yyyy/mm/dd hh24:mi'), 1, 'DOJO: integração contínua', 1);

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO, ID_USUARIO, DS_AGENDAMENTO, ID_SALA) 
values(SEQ_AGENDAMENTO.nextval, TO_DATE('2016/12/14 17:30', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/14 19:00', 'yyyy/mm/dd hh24:mi'), 1, 'Confraternização', 2);
