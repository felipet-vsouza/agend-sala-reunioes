...
INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO) 
values(1, TO_DATE('2016/12/15 09:00', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 12:00', 'yyyy/mm/dd hh24:mi'));

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO) 
values(2, TO_DATE('2016/12/15 12:10', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 14:00', 'yyyy/mm/dd hh24:mi'));

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO) 
values(3, TO_DATE('2016/12/15 15:00', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 16:00', 'yyyy/mm/dd hh24:mi'));

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO) 
values(4, TO_DATE('2016/12/15 17:30', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/15 19:00', 'yyyy/mm/dd hh24:mi'));

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO) 
values(5, TO_DATE('2016/12/16 17:30', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/16 19:00', 'yyyy/mm/dd hh24:mi'));

INSERT INTO Agendamento(ID_AGENDAMENTO, DT_INICIO_AGENDAMENTO, DT_FINAL_AGENDAMENTO) 
values(6, TO_DATE('2016/12/14 17:30', 'yyyy/mm/dd hh24:mi'), TO_DATE('2016/12/14 19:00', 'yyyy/mm/dd hh24:mi'));
